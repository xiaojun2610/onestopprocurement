...
<div class="container-fluid">
		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-md-2">
					<ul class="intemclass pull-right"  id="itemclasslist" >
				...
				<div class="col-md-10">
					...
					<div style="margin:20px 20px 20px 0px">
					   ...
					   <div class="carousel-inner">
					      ...
					      <div class="item">
					         <img src="../img/04.jpg" alt="Second slide">
					      </div>
					      <div class="item">
					         <img src="../img/02.jpg" alt="Third slide">
					      </div>
					   </div>
					   <!-- 轮播（Carousel）导航 -->
                     ...
                     <br/>
							...
							<a href="${pageContext.request.contextPath }/item/scopeItem.action?itemId=${item.itemId}"">
								<div class="thumbnail">
									...
									<div class="caption">
										<h3>${item.itemName }</h3>
										<p>${item.itemDesc }</p>
										<p>促销价：￥<span class="price"><fmt:formatNumber type="number" value="${item.itemPrice*item.itemDiscount}" pattern="0.00" maxFractionDigits="2"></fmt:formatNumber></span> <span class="preprice"><fmt:formatNumber type="number" value="${item.itemPrice}" pattern="0.00" maxFractionDigits="2"></fmt:formatNumber></span></p>
									</div>
								</div>
							</a>
						</div>
						...
						<p id="moreitemsclk" class="pull-right" style="margin-right:30px">更多...</p>
